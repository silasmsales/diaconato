import{$n as xI,A as J,B as LI,Ct as Ug,D as HD,Dt as Vh,E as H,Et as Vg,F as Kf,Gn as v_,Gt as _g,In as po,J as Nl,Jt as aI,N as KD,R as LC,S as FD,Sn as jI,Tt as VI,Wn as vI,X as OD,Z as Of,Zt as bg,bn as jD,bt as Tg,ct as RD,dt as S,en as bt$1,et as PC,ht as Sl,ir as zf,it as Pf,l as Bg,lt as Rg,mn as hD,ot as Qy,pt as Sb,v as E_,w as Gs,wt as V}from"./chunk-YzxS7Zkq.js";import{a as tn,n as K,r as pa,t as m}from"./main-J5KXTTKH.js";import{t as h}from"./chunk-CCITTBlk.js";import{_ as ln,d as Vt$1,f as Xe$1,n as Gn,r as Hn,s as Pn,t as Bn}from"./chunk-CGdlt2S5.js";import{t as f}from"./chunk-B7K6h8rH.js";import{t as f$1}from"./chunk-BNtAhz_6.js";import{t as q}from"./chunk-D4ZwS9zO.js";import{i as p,n as h$1,r as l}from"./chunk-D7vhSc13.js";import{t as o}from"./chunk-uz4g6ehC.js";import{t as w}from"./chunk-B-001ps0.js";import{r as t,t as b}from"./chunk-DYullDaB.js";var se=class a{getDiaSemanaFromData(t){if(!t)return``;let e=t.split(`-`);return o[new Date(Number(e[0]),Number(e[1])-1,Number(e[2])).getDay()+1]||``}formatDateBR(t){if(!t)return``;let e=t.split(`-`);return e.length===3?`${e[2]}/${e[1]}/${e[0]}`:t}agruparEventosPorSemana(t){if(!t||t.length===0)return[];let e=new Map;for(let r of t){if(!r.data)continue;let d=r.data.split(`-`),b=new Date(Number(d[0]),Number(d[1])-1,Number(d[2])),f=b.getDay(),h=new Date(b);h.setDate(b.getDate()-f);let E=new Date(h);E.setDate(h.getDate()+6);let m=h.toISOString().split(`T`)[0],S=`${String(h.getDate()).padStart(2,`0`)}/${String(h.getMonth()+1).padStart(2,`0`)}`,p=`${String(E.getDate()).padStart(2,`0`)}/${String(E.getMonth()+1).padStart(2,`0`)}`;e.has(m)||e.set(m,{startFmt:S,endFmt:p,startKey:m,eventos:[]}),e.get(m).eventos.push(r)}return Array.from(e.values()).sort((r,d)=>r.startKey.localeCompare(d.startKey)).map((r,d)=>({titulo:`SEMANA ${d+1} (${r.startFmt} a ${r.endFmt})`,eventos:r.eventos.sort((b,f)=>{let h=(b.data||``).localeCompare(f.data||``);return h!==0?h:(b.turno||0)-(f.turno||0)})}))}openPrintWindow(t,e){let n=window.open(``,`_blank`,`width=1000,height=800`);if(!n){alert(`Por favor, permita pop-ups para gerar o PDF da escala.`);return}`${document.baseURI}`;let d=`
      <!DOCTYPE html>
      <html lang="pt-BR">
      <head>
        <meta charset="UTF-8">
